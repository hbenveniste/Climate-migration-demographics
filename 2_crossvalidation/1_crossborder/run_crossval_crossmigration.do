...
- residualize the variables used in the cross-validation
- select independent variables for each model
- use "crossval_function_crossmigration.do" to run 10-fold cross-validation for each model
...
****************************************************************
do "$code_dir/2_crossvalidation/1_crossborder/resid_crossmigration.do"
...
use "$input_dir/2_intermediate/_residualized_cross.dta"
#delimit ;
global indepvar "tmax_dp_age1 tmax_dp_age2 tmax_dp_age3 tmax_dp_age4  
				sm_dp_age1 sm_dp_age2 sm_dp_age3 sm_dp_age4 sm2_dp_age1 sm2_dp_age2 sm2_dp_age3 sm2_dp_age4 sm3_dp_age1 sm3_dp_age2 sm3_dp_age3 sm3_dp_age4
