...
reghdfe `depvar' `indepvar', absorb(i.bpl#i.country#i.demo yrimm i.bpl##c.yrimm) vce(cluster bpl)
estimates save "$input_dir/5_estimation/mcross_tspd3_cz_zeros.ster", replace
...
* Export plot 
graph export "$res_dir/4_Estimation_crossmig/FigSX_crosstemp_zeros.png", width(4000) as(png) name("graphcurveall") replace
...
estimates use "$input_dir/5_estimation/mcross_tspd3_cz_zeros.ster"
local line_base = "_b[tmax_dp]* (t - `tmean')+ _b[tmax2_dp] * (t^2 - `tmean'^2)+ _b[tmax3_dp] * (t^3 - `tmean'^3)"
local line_clim1 = "0"
forv c=2/5 {
...
graph export "$res_dir/4_Estimation_crossmig/FigSX_crosstemp_zeros_cz.png", width(4000) as(png) name("graphcurveall") replace
...
* Export plot 
graph export "$res_dir/4_Estimation_crossmig/FigSX_crosssoilm_zeros.png", width(4000) as(png) name("graphcurveall") replace
...
do "$code_dir/3_estimation/1_crossborder/curvesclim_plot_function_crossmigration.do"
graph export "$res_dir/4_Estimation_crossmig/FigSX_crosssoilm_zeros_cz.png", width(4000) as(png) name("graphcurveall") replace
