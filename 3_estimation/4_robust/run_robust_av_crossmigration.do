...
* Export plot 
graph export "../../mig-demo-ag/Cleaned/Results/Estimation_crossmig/FigE9c_crosstempav10.png", width(4000) as(png) name("graphcurveall") replace
...
* Export plot 
graph export "$res_dir/4_Estimation_crossmig/FigE8e_crosssoilmav10.png", width(4000) as(png) name("graphcurveall") replace
