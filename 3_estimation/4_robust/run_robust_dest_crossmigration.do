...
local indepvar c.tmax_dp##i.agemigcat c.tmax2_dp##i.agemigcat c.tmax3_dp##i.agemigcat ///
				c.sm_dp##i.agemigcat c.sm2_dp##i.agemigcat c.sm3_dp##i.agemigcat ///
				c.tmax_dp##i.edattain c.tmax2_dp##i.edattain c.tmax3_dp##i.edattain ///
				c.sm_dp##i.edattain c.sm2_dp##i.edattain c.sm3_dp##i.edattain ///
				c.tmax_dp_des##i.agemigcat c.tmax2_dp_des##i.agemigcat c.tmax3_dp_des##i.agemigcat ///
				c.sm_dp_des##i.agemigcat c.sm2_dp_des##i.agemigcat c.sm3_dp_des##i.agemigcat ///
				c.tmax_dp_des##i.edattain c.tmax2_dp_des##i.edattain c.tmax3_dp_des##i.edattain ///
				c.sm_dp_des##i.edattain c.sm2_dp_des##i.edattain c.sm3_dp_des##i.edattain ///
				c.tmax_dp##i.mainclimgroup c.tmax2_dp##i.mainclimgroup c.tmax3_dp##i.mainclimgroup ///
				c.sm_dp##i.mainclimgroup c.sm2_dp##i.mainclimgroup c.sm3_dp##i.mainclimgroup ///
				c.tmax_dp_des##i.agemigcat c.tmax2_dp_des##i.agemigcat c.tmax3_dp_des##i.agemigcat ///
				c.sm_dp_des##i.agemigcat c.sm2_dp_des##i.agemigcat c.sm3_dp_des##i.agemigcat ///
				c.tmax_dp_des##i.mainclimgroup c.tmax2_dp_des##i.mainclimgroup c.tmax3_dp_des##i.mainclimgroup ///
				c.sm_dp_des##i.mainclimgroup c.sm2_dp_des##i.mainclimgroup c.sm3_dp_des##i.mainclimgroup
...
forvalues c=1/5 {
	...
	* Calculate migration responses per climate zone, age and education based on estimates
	estimates use "$input_dir/5_estimation/mcross_tspd3_dd_eduagecz.ster"

	local line_base = "_b[tmax_dp_des]* (t - `tmean_`c'')+ _b[tmax2_dp_des] * (t^2 - `tmean_`c''^2)+ _b[tmax3_dp_des] * (t^3 - `tmean_`c''^3)"
	local line_age1 = "0"
	local line_edu1 = "0"
	forv i = 2/4 {
		local line_age`i' = "_b[`i'.agemigcat#c.tmax_dp_des]* (t - `tmean_`c'')+ _b[`i'.agemigcat#c.tmax2_dp_des] * (t^2 - `tmean_`c''^2)+ _b[`i'.agemigcat#c.tmax3_dp_des] * (t^3 - `tmean_`c''^3)"
		local line_edu`i' = "_b[`i'.edattain#c.tmax_dp_des]* (t - `tmean_`c'')+ _b[`i'.edattain#c.tmax2_dp_des] * (t^2 - `tmean_`c''^2)+ _b[`i'.edattain#c.tmax3_dp_des] * (t^3 - `tmean_`c''^3)"
	}
	if `c' == 1 {
		local line_clim = "0"
	}
	else {
		local line_clim = "_b[`c'.mainclimgroup#c.tmax_dp_des]* (t - `tmean_`c'') + _b[`c'.mainclimgroup#c.tmax2_dp_des] * (t^2 - `tmean_`c''^2)+ _b[`c'.mainclimgroup#c.tmax3_dp_des] * (t^3 - `tmean_`c''^3)"
	}
	...
	* Calculate migration responses without heterogeneity based on estimates
	...
	local line0 = "_b[tmax_dp_des]* (t - `tmean_`c'')+ _b[tmax2_dp_des] * (t^2 - `tmean_`c''^2)+ _b[tmax3_dp_des] * (t^3 - `tmean_`c''^3)"
	...
	* Export plot 
	graph export "$res_dir/4_Estimation_crossmig/FigS12c_crosstempdest_`c'.png", width(4000) as(png) name("graphcurveall") replace
...
forvalues c=1/5 {
	...
	* Calculate migration responses per climate zone, age and education based on estimates
	...
	local line_base = "_b[sm_dp_des]* (sm - `smmean_`c'') + _b[sm2_dp_des] * (sm^2 - `smmean_`c''^2) + _b[sm3_dp_des] * (sm^3 - `smmean_`c''^3)"
	local line_age1 = "0"
	local line_edu1 = "0"
	forv i = 2/4 {
		local line_age`i' = "_b[`i'.agemigcat#c.sm_dp_des]* (sm - `smmean_`c'') + _b[`i'.agemigcat#c.sm2_dp_des] * (sm^2 - `smmean_`c''^2) + _b[`i'.agemigcat#c.sm3_dp_des] * (sm^3 - `smmean_`c''^3)"
		local line_edu`i' = "_b[`i'.edattain#c.sm_dp_des]* (sm - `smmean_`c'') + _b[`i'.edattain#c.sm2_dp_des] * (sm^2 - `smmean_`c''^2) + _b[`i'.edattain#c.sm3_dp_des] * (sm^3 - `smmean_`c''^3)"
	}
	if `c' == 1 {
		local line_clim = "0"
	}
	else {
		local line_clim = "_b[`c'.mainclimgroup#c.sm_dp_des]* (sm - `smmean_`c'') + _b[`c'.mainclimgroup#c.sm2_dp_des] * (sm^2 - `smmean_`c''^2)+ _b[`c'.mainclimgroup#c.sm3_dp_des] * (sm^3 - `smmean_`c''^3)"
	}
	...
	* Calculate migration responses without heterogeneity based on estimates
	...
	local line0 = "_b[sm_dp_des]* (sm - `smmean_`c'') + _b[sm2_dp_des] * (sm^2 - `smmean_`c''^2) + _b[sm3_dp_des] * (sm^3 - `smmean_`c''^3)"
	...
	* Export plot 
	graph export "$res_dir/4_Estimation_crossmig/FigS12e_crosssoilmdest_`c'.png", width(4000) as(png) name("graphcurveall") replace
