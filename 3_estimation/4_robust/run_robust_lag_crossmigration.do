...
* Export plot 
graph export "$res_dir/4_Estimation_crossmig/FigS12c_crosstemplag.png", width(4000) as(png) name("graphcurveall") replace
...
graph export "$res_dir/4_Estimation_crossmig/FigS12c_crosstemplag_cz.png", width(4000) as(png) name("graphcurveall") replace
...
* Export plot 
graph export "$res_dir/4_Estimation_crossmig/FigS12e_crosssoilmlag.png", width(4000) as(png) name("graphcurveall") replace
...
global range_plot `range_cz'
do "$code_dir/3_estimation/1_crossborder/curvesclim_plot_function_crossmigration.do"
graph export "$res_dir/4_Estimation_crossmig/FigS12e_crosssoilmlag_cz.png", width(4000) as(png) name("graphcurveall") replace
