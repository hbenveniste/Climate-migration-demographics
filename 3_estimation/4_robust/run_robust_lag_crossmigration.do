...
reghdfe `depvar' `indepvar', absorb(i.bpl#i.country#i.demo yrimm i.bpl##c.yrimm) vce(cluster bpl)
estimates save "$input_dir/5_estimation/mcross_tspd3_l1_cz.ster", replace
...
local line_base = "_b[tmax_dp_l1]* (t - `tmean')+ _b[tmax2_dp_l1] * (t^2 - `tmean'^2)+ _b[tmax3_dp_l1] * (t^3 - `tmean'^3)"
local line_age1 = "0"
local line_edu1 = "0"
forv i = 2/4 {
	local line_age`i' = "_b[`i'.agemigcat#c.tmax_dp_l1]* (t - `tmean')+ _b[`i'.agemigcat#c.tmax2_dp_l1] * (t^2 - `tmean'^2)+ _b[`i'.agemigcat#c.tmax3_dp_l1] * (t^3 - `tmean'^3)"
	local line_edu`i' = "_b[`i'.edattain#c.tmax_dp_l1]* (t - `tmean')+ _b[`i'.edattain#c.tmax2_dp_l1] * (t^2 - `tmean'^2)+ _b[`i'.edattain#c.tmax3_dp_l1] * (t^3 - `tmean'^3)"
}
...
local line0 = "_b[tmax_dp_l1]* (t - `tmean')+ _b[tmax2_dp_l1] * (t^2 - `tmean'^2)+ _b[tmax3_dp_l1] * (t^3 - `tmean'^3)"
...
* Export plot 
graph export "$res_dir/4_Estimation_crossmig/FigS11c_crosstemplag.png", width(4000) as(png) name("graphcurveall") replace
...
estimates use "$input_dir/5_estimation/mcross_tspd3_l1_cz.ster"
local line_base = "_b[tmax_dp_l1]* (t - `tmean')+ _b[tmax2_dp_l1] * (t^2 - `tmean'^2)+ _b[tmax3_dp_l1] * (t^3 - `tmean'^3)"
local line_clim1 = "0"
forv c=2/5 {
	local line_clim`c' = "_b[`c'.mainclimgroup#c.tmax_dp_l1]* (t - `tmean') + _b[`c'.mainclimgroup#c.tmax2_dp_l1] * (t^2 - `tmean'^2)+ _b[`c'.mainclimgroup#c.tmax3_dp_l1] * (t^3 - `tmean'^3)"
}
forv c=1/5 {
...
graph export "$res_dir/4_Estimation_crossmig/FigS11c_crosstemplag_cz.png", width(4000) as(png) name("graphcurveall") replace
...
local line_base = "_b[sm_dp_l1]* (sm - `smmean') + _b[sm2_dp_l1] * (sm^2 - `smmean'^2) + _b[sm3_dp_l1] * (sm^3 - `smmean'^3)"
local line_age1 = "0"
local line_edu1 = "0"
forv i = 2/4 {
	local line_age`i' = "_b[`i'.agemigcat#c.sm_dp_l1]* (sm - `smmean') + _b[`i'.agemigcat#c.sm2_dp_l1] * (sm^2 - `smmean'^2) + _b[`i'.agemigcat#c.sm3_dp_l1] * (sm^3 - `smmean'^3)"
	local line_edu`i' = "_b[`i'.edattain#c.sm_dp_l1]* (sm - `smmean') + _b[`i'.edattain#c.sm2_dp_l1] * (sm^2 - `smmean'^2) + _b[`i'.edattain#c.sm3_dp_l1] * (sm^3 - `smmean'^3)"
}
...
local line0 = "_b[sm_dp_l1]* (sm - `smmean') + _b[sm2_dp_l1] * (sm^2 - `smmean'^2) + _b[sm3_dp_l1] * (sm^3 - `smmean'^3)"
...
* Export plot 
graph export "$res_dir/4_Estimation_crossmig/FigS11e_crosssoilmlag.png", width(4000) as(png) name("graphcurveall") replace
...
local line_clim1 = "0"
forv c=2/5 {
	local line_clim`c' = "_b[`c'.mainclimgroup#c.sm_dp_l1]* (sm - `smmean') + _b[`c'.mainclimgroup#c.sm2_dp_l1] * (sm^2 - `smmean'^2)+ _b[`c'.mainclimgroup#c.sm3_dp_l1] * (sm^3 - `smmean'^3)"
}
forv c=1/5 {
	predictnl yhat`c' = `line_base' + `line_clim`c'' , ci(lowerci`c' upperci`c') level(90)
	foreach var of varlist yhat`c' lowerci`c' upperci`c' {
...
global range_plot `range_cz'
do "$code_dir/3_estimation/1_crossborder/curvesclim_plot_function_crossmigration.do"
graph export "$res_dir/4_Estimation_crossmig/FigS11e_crosssoilmlag_cz.png", width(4000) as(png) name("graphcurveall") replace
