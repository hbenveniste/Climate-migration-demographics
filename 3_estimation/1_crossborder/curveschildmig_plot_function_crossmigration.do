...
Function that plots migration response curves for the robustness check on having a child or not at time of migration
...
forv k=0/1 {	
	local cmigname: label (childmig) `k'
	...
	local graphcurve "`graphcurve' Respcurve_cmig`k'"
}		
