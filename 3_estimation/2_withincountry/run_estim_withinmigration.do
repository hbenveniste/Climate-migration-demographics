...
local indepvar c.tmax_day_pop_uncert##i.climgroup##i.agemigcat c.tmax2_day_pop_uncert##i.climgroup##i.agemigcat c.tmax3_day_pop_uncert##i.climgroup##i.agemigcat c.sm_day_pop_uncert##i.climgroup##i.agemigcat c.sm2_day_pop_uncert##i.climgroup##i.agemigcat c.sm3_day_pop_uncert##i.climgroup##i.agemigcat c.tmax_day_pop_uncert##i.climgroup##i.edattain c.tmax2_day_pop_uncert##i.climgroup##i.edattain c.tmax3_day_pop_uncert##i.climgroup##i.edattain c.sm_day_pop_uncert##i.climgroup##i.edattain c.sm2_day_pop_uncert##i.climgroup##i.edattain c.sm3_day_pop_uncert##i.climgroup##i.edattain
...
local indepvar c.tmax_day_pop_uncert##i.climgroup c.tmax2_day_pop_uncert##i.climgroup c.tmax3_day_pop_uncert##i.climgroup c.sm_day_pop_uncert##i.climgroup c.sm2_day_pop_uncert##i.climgroup c.sm3_day_pop_uncert##i.climgroup
...
local indepvar c.tmax_day_pop_uncert c.tmax2_day_pop_uncert c.tmax3_day_pop_uncert c.sm_day_pop_uncert c.sm2_day_pop_uncert c.sm3_day_pop_uncert
...
* Label variables
label variable tmax_day_pop_uncert "T"
label variable tmax2_day_pop_uncert "T2"
label variable tmax3_day_pop_uncert "T3"
label variable sm_day_pop_uncert "S"
label variable sm2_day_pop_uncert "S2"
label variable sm3_day_pop_uncert "S3"
...
label define climgroupname 1 "tropical" 2 "dry cold" 3 "dry hot" 4 "temperate" 5 "continental", modify
...
* Export table in .csv
#delimit ;
esttab mwithin_tspd3 mwithin_tspd3_cz mwithin_tspd3_cz_eduage using "$res_dir/4_Estimation_withinmig/tableA2_withindemo.csv", 
