...
forvalues c=1/5 {
	...
	* Plot response curves
	...
	if `demoplot' {
		...
		* Export plot 
		graph export "$res_dir/5_Estimation_withinmig/Fig3b_withintemp_`c'.png", width(4000) as(png) name("graphcurveall") replace
	}
...
forvalues c=1/5 {
	...
	* Plot response curves
	...
	if `demoplot' {	
		...
		* Export plot 
		graph export "$res_dir/5_Estimation_withinmig/Fig3c_withinsoilm_`c'.png", width(4000) as(png) name("graphcurveall") replace
	}
...
if `climplot' {
	...
	graph export "$res_dir/5_Estimation_withinmig/FigE5_withinclim.png", width(4000) as(png) name("graphcurveclim") replace
}
