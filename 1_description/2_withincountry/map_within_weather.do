...
keep ctrymig ctrycode geomig1 yrmig tmax_day_pop_uncert sm_day_pop_uncert  
duplicates drop

* Average temperature and soil moisture values over the sample period
collapse (mean) tmax_day_pop_uncert sm_day_pop_uncert, by(ctrymig ctrycode geomig1)

* Match with shape file 
merge 1:m geomig1 using "Shapefiles/geo1db.dta"
keep geomig1 ctrycode tmax_day_pop_uncert sm_day_pop_uncert id
